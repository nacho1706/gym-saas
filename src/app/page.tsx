...
export default function Home() {
  return (
    <div>
        ...
        <MaxWidthWrapper className="relative pb-24 pt-10 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-0 lg:pb-52 xl:gap-x-8 xl:pt-32 z-20">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center">
              <h1 className="relative w-fit tracking-tight text-balance mt-10 font-bold !leading-tight text-white text-7xl lg:text-8xl lg:text-center">
      ...
      <section className="relative w-full h-60 bg-black shadow-[0px_-65px_31px_38px_#0000004d,0px_-52px_26px_0px_#0000004d,0px_-24px_20px_0px_#0000004d,0px_-19px_2px_5px_#0000004d] z-20"></section>
    </div>
  );
}
